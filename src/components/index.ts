...
export { default as QuizForm } from './Quiz/QuizForm/QuizForm';
...
// MAIN
export { default as MainLayout } from './Main/MainLayout/MainLayout';
export { default as MainHeader } from './Main/MainHeader/MainHeader';
